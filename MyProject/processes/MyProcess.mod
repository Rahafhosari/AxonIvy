...
Ms0 f1 433 49 30 30 0 15 #rect
Ms0 f1 @|EndIcon #fIcon
Ms0 f3 dialogId my.project.EnterProduct #txt
Ms0 f3 startMethod start(my.project.Data) #txt
Ms0 f3 requestActionDecl '<my.project.Data data> param;' #txt
...
' #txt
Ms0 f3 168 42 112 44 -36 -8 #rect
...
' #txt
Ms0 f5 336 48 32 32 -56 -35 #rect
...
' #txt
Ms0 f2 368 64 433 64 #arcP
Ms0 f2 0 0.4 0 8 #arcLabel
Ms0 f7 433 113 30 30 0 15 #rect
...
' #txt
Ms0 f8 352 80 433 128 #arcP
Ms0 f8 1 352 128 #addKink
Ms0 f8 1 0.5061728395061729 0 8 #arcLabel
